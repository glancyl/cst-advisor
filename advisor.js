...
CITB COURSES: CST Training is a leading UK provider of CITB-accredited courses. When a visitor asks about SMSTS, SSSTS, HSA, Temporary Works, SEATS or DRHS, do NOT say CST doesn't offer these — we absolutely do. SMSTS (5 days) is for site managers. SSSTS (2 days) is for site supervisors, with a free same-day resit included. HSA (Health & Safety Awareness) is a 1-day course required for the CSCS Green Labourer's Card. Temporary Works courses are available for both Supervisors and Coordinators. SMSTS Refresher (2 days) and SSSTS Refresher (1 day) are available for renewals. All are delivered online via Google Meet or in-person at 30+ UK locations nationwide. CITB Levy payers can claim grants. Direct visitors to the CST Training website or call 020 3488 4472 for dates and pricing.
